...
class TwilioCallViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(TwilioCallViewController.dismissKeyboard))
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        self.roomTextField.text = "LivelyChat"
    ...
    func startPreview() {
        ...
        if (frontCamera != nil || backCamera != nil) {
            ...
            if (frontCamera != nil && backCamera != nil) {
                ...
                let tap = UITapGestureRecognizer(target: self, action: #selector(TwilioCallViewController.flipCamera))
...
extension TwilioCallViewController : UITextFieldDelegate {
...
// MARK:- RoomDelegate
extension TwilioCallViewController : RoomDelegate {
...
extension TwilioCallViewController : RemoteParticipantDelegate {
...
extension TwilioCallViewController : VideoViewDelegate {
...
extension TwilioCallViewController : CameraSourceDelegate {
